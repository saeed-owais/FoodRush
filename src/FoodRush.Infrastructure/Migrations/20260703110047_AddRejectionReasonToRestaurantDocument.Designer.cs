...
namespace FoodRush.Infrastructure.Migrations
{
    ...
    [Migration("20260703110047_AddRejectionReasonToRestaurantDocument")]
    partial class AddRejectionReasonToRestaurantDocument
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodRush.Domain.Restaurants.Entities.RestaurantDocument.RestaurantDocument", b =>
                {
                    ...
                    b.OwnsOne("FoodRush.Domain.Restaurants.Entities.RestaurantDocument.RejectionReason", "RejectionReason", b1 =>
                        {
                            b1.Property<Guid>("RestaurantDocumentId")
                                .HasColumnType("uniqueidentifier");
